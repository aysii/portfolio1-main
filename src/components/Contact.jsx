...
const Contact = () => {
  return (
    <div className='pt-16 pb-10 sm:pt-16 sm:pb-16 lg:pb-16 md:h-[92vh]'>
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10 bg-[#223]/30 rounded-3xl">
            <div class="mb-4">
                <div class="mb-6 max-w-3xl text-center sm:text-center md:mx-auto ">
                    <h2
                        class="mb-4 font-bold tracking-tight gray-primary-color text-3xl sm:text-5xl">
                        Connect with me!
                    </h2>
            ...
            <div class="flex justify-center">
                <div class="grid md:grid-cols-2">
                        ...
                        <ul>
                            ...
                            <li class="flex">
                                ...
                                <div class="m-5">
                                    ...
                                    <p class="text-gray-400">Email: jamesonmanabat15@gmail.com</p>
                                </div>
                            </li>
                            <li class="flex">
                    ...
                    <div class="max-w-6xl p-5 md:p-12" id="form">
                        ...
                        <input type="hidden" name="access_key" value="9169604c-d968-4955-8528-d7bada38dd17"/>
                            <div class="mb-6">
